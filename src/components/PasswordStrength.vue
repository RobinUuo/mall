  ...
  <div id="container">
    <el-row>
      <el-col :span="6" :offset="1">
        <el-progress :percentage="onePercentage" :color="oneCustomColors" :format="oneFormat" :stroke-width="5"></el-progress>
      </el-col>
      <el-col :span="6" :offset="1">
        <el-progress :percentage="twoPercentage" :color="twoCustomColors" :format="twoFormat" :stroke-width="5"></el-progress>
      </el-col>
      <el-col :span="6" :offset="1">
        <el-progress :percentage="ThreePercentage" :color="ThreeCustomColors" :format="ThreeFormat" :stroke-width="5"></el-progress>
      </el-col>
